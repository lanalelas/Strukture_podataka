...
int main() {
	...
	printf("Za saznati koliko je sveukupno novca potroseno i na koliku kolicina odredenog artikla u nekom vremenskom razdoblju upisite ime tog artikla i trazeno vremensko razdoblje u formatu 'ime YYYY-MM-DD YYYY-MM-DD' : ");
